...
VOut ModelVS(float4 position : POSITION, float4 color : COLOR,
	float2 texcoord : TEXCOORD, float3 normal : NORMAL)
{
	VOut output;
...
float4 ModelPS(float4 position : SV_POSITION, float4 color : COLOR,
